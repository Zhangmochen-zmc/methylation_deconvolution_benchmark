...
#path of input files
test_files = {
    "B cells":              r"/data/weiyk/data/test_data/array_data/GSE88824/bcell.txt",
    "CD4+ T cells":         r"/data/weiyk/data/test_data/array_data/GSE88824/cd4.txt",
    "CD8+ T cells":         r"/data/weiyk/data/test_data/array_data/GSE88824/cd8.txt",
    "Monocytes":            r"/data/weiyk/data/test_data/array_data/GSE88824/monocyte.txt",
    "Neutrophils":          r"/data/weiyk/data/test_data/array_data/GSE88824/neutrophil.txt",
    "Natural Killer cells": r"/data/weiyk/data/test_data/array_data/GSE88824/nk.txt"
}
...
output_file = "mix_data/simulated_matrix_850klow_nk.csv"
