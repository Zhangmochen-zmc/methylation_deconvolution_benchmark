...
# DHS merger
DHS_cpg_path <- "/data/zhangmch/deconvolution_benchmark/requirement/DHS/epigenomic-roadmap/filtered_cg_info_450k.bed"
# DHS alone
# DHS_cpg_path <- "/data/zhangmch/deconvolution_benchmark/requirement/DHS/epigenomic-roadmap/450k_DHS_cell_type"
output_dir <- "epidish_ref"
