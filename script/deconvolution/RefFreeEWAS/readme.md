...
**Input:** `.txt`(`ref_data`)    
**Output:** `reference_output_RefFreeEWAS.csv` (`reffreeewas_ref`)
...
### Notes
*   **More Information**: [https://github.com/eahouseman/RefFreeEWAS.git](https://github.com/eahouseman/RefFreeEWAS.git)
